...
const dashHTML = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>Permit</title>
...
<div class="hdr"><h1><span>&#9670;</span> PERMIT</h1><button class="btn btn-p" id="add-btn">+ Add</button></div>
<div class="main">
<div class="stats" id="stats-permits"></div>
<div class="toolbar">
<input class="search" id="search-permits" placeholder="Search..." oninput="renderRes('permits')"><select class="filter-sel" id="filter-permits-status" onchange="renderRes('permits')"><option value="">All Status</option><option value="Active">Active</option><option value="Pending">Pending</option><option value="Expired">Expired</option><option value="Revoked">Revoked</option><option value="Suspended">Suspended</option></select></div>
<div class="count-label" id="count-permits"></div>
<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Permit Type</th><th>Holder Name</th><th>Email</th><th>Permit #</th><th>Issued</th><th>Expires</th><th>Issuing Authority</th><th>Status</th><th>Cost ($)</th><th>Notes</th><th></th></tr></thead><tbody id="tbody-permits"></tbody></table></div></div><div class="modal-bg" id="mbg" onclick="if(event.target===this)closeModal()"><div class="modal" id="mdl"></div></div><script>var A="/api",data={},editId=null,activeRes="permits";var resCfg={"permits":{d:"Permits",f:[{n:"permit_type",l:"Permit Type",t:"text",r:true,o:[]},{n:"holder_name",l:"Holder Name",t:"text",r:true,o:[]},{n:"holder_email",l:"Email",t:"email",r:false,o:[]},{n:"permit_number",l:"Permit #",t:"text",r:false,o:[]},{n:"issued_date",l:"Issued",t:"date",r:false,o:[]},{n:"expiry_date",l:"Expires",t:"date",r:false,o:[]},{n:"issuing_authority",l:"Issuing Authority",t:"text",r:false,o:[]},{n:"status",l:"Status",t:"select",r:false,o:["Active","Pending","Expired","Revoked","Suspended"]},{n:"cost",l:"Cost ($)",t:"number",r:false,o:[]},{n:"notes",l:"Notes",t:"textarea",r:false,o:[]}]},};
...
if(typeof renderRes==='function'){renderRes('permits')}
}else{
